...
public:
  ...
  template<
    ...
    >
  >
  memory(const sc_module_name& nm, T&& alt_input) : sc_module(nm),
    input("input"), output("output"), clk_in("clk_in"), read_input("read_input"),
    addres_input("addres_input"), data(1 << size)
  {
